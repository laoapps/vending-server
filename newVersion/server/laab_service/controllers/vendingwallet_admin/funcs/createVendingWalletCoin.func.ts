...
export class CreateVendingWalletCoinFunc {
    ...
    public Init(params: any): Promise<any> {
        return new Promise<any> (async (resolve, reject) => {
            ...
            try {
                ...
                const RegisterCoinVendingWallet = await this.RegisterCoinVendingWallet();
                if (RegisterCoinVendingWallet != IENMessage.success) throw new Error(RegisterCoinVendingWallet);
    ...
    private FindVendingWallet(): Promise<any> {
        return new Promise<any> (async (resolve, reject) => {
            try {
                ...
                if (run == null) throw new Error(IENMessage.invalidVendingWallet);
                this.uuid = run.uuid;
    ...
    private RegisterCoinVendingWallet(): Promise<any> {
        return new Promise<any> (async (resolve, reject) => {
            try {
