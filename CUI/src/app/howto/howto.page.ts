...
export class HowtoPage implements OnInit {
  ...
  ionViewWillEnter(): void {
    this.list.push({name:'demo',title:'demo',description:'demo',url:'assets/howtovideo/demo.mp4',image:'',id:0})
    this.list.push({name:'demo2',title:'demo2',description:'demo2',url:'assets/howtovideo/demo.mp4',image:'',id:0})
    this.list.push({name:'demo3',title:'demo3',description:'demo3',url:'assets/howtovideo/demo.mp4',image:'',id:0})
    this.list.push({name:'demo4',title:'demo4',description:'demo4',url:'assets/howtovideo/demo.mp4',image:'',id:0})
...
//   private dcimIOS = 'file:///var/mobile/Media/DCIM/100APPLE/IMG_0011.MOV';
  ...
  async testVideoPlayerPlugin(url:string) {
    this.url=url
    const vType='mp4'
//     if(vType === 'mp4') {
//       this.url = this.mp4;
