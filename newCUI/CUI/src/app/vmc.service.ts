...
//   }
//   // public write(data: string): Promise<void> { return this.serialService.writeVMC(data); }
...
//             that.serialService.writeVMC(buff?.b).then((e) => {
//               if (e) {
...
//             that.serialService.writeVMC(x).then((e) => {
