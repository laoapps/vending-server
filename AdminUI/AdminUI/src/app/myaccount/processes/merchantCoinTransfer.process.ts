...
export class MerchantCoinTransferProcess {
    ...
    private ValidateParams(): string {
        if (!(this.ownerUuid && this.sender && this.receiver && this.amount && this.description && this.coinListId && this.coinCode && this.limitBlock)) return IENMessage.parametersEmpty;
