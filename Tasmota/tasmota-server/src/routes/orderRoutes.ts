...
import { createOrder, getOrders, getOrderById, payOrder, completeOrder, testOrder, getOrderByIdHMVending, getActiveOrdersByDeviceID, createOrderHMVending, findAllActiveDevices } from '../controllers/orderController';
...
router.post('/findAllActiveDevices', findAllActiveDevices); // Create order (user only)
