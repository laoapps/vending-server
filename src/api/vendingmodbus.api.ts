...
export class VendingServer {
    ...
    command(command: string) {
        ...
        this.client.writeRegisters(1, buff);
        this.client.readHoldingRegisters(1, buff.length)
    }
    write() {
        this.client.setID(1);
