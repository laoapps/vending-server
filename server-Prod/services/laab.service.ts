...
export const Self_CALLBACK_CashValidation: string = `${process.env.TEST_CALLBACK}/laab/client/cash_vxalidation` || `http://localhost:9006/laab/client/cash_validation`;
