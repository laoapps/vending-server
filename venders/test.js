...
function checkSum(buff) {
    try {
        var x = crc_1["default"].crc16modbus(Buffer.from(buff.join(''), 'hex')).toString(16);
        x.length < 4 ? x = '0' + x : '';
        console.log(x);
        console.log(x.substring(2) + x.substring(0, 2));
        return x.substring(2) + x.substring(0, 2);
...
var port = new serialport_1.SerialPort({ path: path, baudRate: 9600 }, function (err) {
    if (err) {
        return console.log('Error: ', err.message);
    }
    console.log("port " + path + " accessed");
    ...
    // CHECK HARDWARE VERSION 
    // const buff = ['01','03', '00', '01', '00', '02', '95', 'CB'];
    var buff = ['01', '01', '00', '00', '00', '00', '00', '00', '00', '00', '00', '00', '00', '00', '00', '00', '00', '00', '71', '88'];
