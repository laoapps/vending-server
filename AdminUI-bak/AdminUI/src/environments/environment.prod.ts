export const environment = {
  production: true,
  baseurl:'https://vendingservicevmc.laoapps.com',
  url:'https://vendingservicevmc.laoapps.com/zdm8',
  wsurl:'wss://vendingservicevmc.laoapps.com/zdm8',
  filemanagerurl: 'https://filemanager-api.laoapps.com/api/v1/file/',
  // filemanagerurl: 'http://192.168.2.107:24556/api/v1/file/'

  //filemanagerurl: 'https://localhost:27701/api/v1/file/'
