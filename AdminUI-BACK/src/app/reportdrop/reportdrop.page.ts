...
@Component({
  selector: 'app-reportdrop',
  templateUrl: './reportdrop.page.html',
  styleUrls: ['./reportdrop.page.scss'],
})
export class ReportdropPage implements OnInit {
  ...
  process(): Promise<any> {
    return new Promise<any>(async (resolve, reject) => {
      try {
        ...
        this.apiService.loadVendingMachineDropReport(paramsData).subscribe(async r => {
